      ...
      <div className="container footer-container">
        ...
        <div className="footer-col brand-col">
          ...
          <div className="social-links">
            ...
            <a href="https://snapchat.com/t/nyf5Gknb" target="_blank" rel="noreferrer" className="social-icon" aria-label="Snapchat">
              <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.tiktok.com/@pomagency1?_r=1&_t=ZS-99B1xBv2qn4" target="_blank" rel="noreferrer" className="social-icon" aria-label="TikTok">
              <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
